...
const apartments = [
  {
    ...
    description:
      'The flat for rent provides the exact comfortable lifestyle that you have been looking for. Covers area as a whole flat also has facilities that come along whit this edifice.',
    ...
    return (
      <ScrollView style={{backgroundColor: 'white'}}>
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', fontSize: 18, color: '#0f1c3d'}}>
            {apartment.title}t
          </Text>
          <View
            style={{
            ...
            <Text style={{fontSize: 14, color: '#aaadc3'}}>
              {apartment.place}
            </Text>
            <View
              style={{
          ...
          <View
            ...
            <Text style={{fontSize: 25, color: '#4972df', fontWeight: 'bold'}}>
              {apartment.price}
              <Text
                style={{fontSize: 12, color: '#aaadc3', fontWeight: 'normal'}}>
                {' '}
                / mo
              </Text>
            </Text>
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', fontSize: 16, color: '#0f1c3d'}}>
            Description:
          </Text>
          <Text
            style={{
        ...
        <View
          ...
          <View style={{marginLeft: 15}}>
            ...
            <Text style={{fontWeight: 'bold', color: '#0f1c3d', fontSize: 16}}>
              {apartment.ownerName}
            </Text>
          </View>
...
const ApartmentCard = props => {
  return (
    <TouchableHighlight
      ...
      underlayColor="white"
      onPress={() => {
        props.navigation.navigate('Details', {apartmentId: props.apartment.id});
      }}>
      <View
        style={{
          flexDirection: 'row',
        ...
        <View>
          <Image
            source={{uri: props.apartment.image}}
            style={{
              height: 150,
              width: 100,
              resizeMode: 'cover',
        ...
        <View style={{marginLeft: 15, justifyContent: 'space-between'}}>
          ...
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Text style={{fontWeight: 'bold', color: 'black'}}>
                {' '}
                {props.apartment.washing_machines}
              </Text>
            </View>
          </View>
          <View
      ...
      <ScrollView style={{backgroundColor: 'white'}}>
        <View
          ...
          <View style={{marginLeft: 10}}>
            ...
            <Text style={{fontSize: 18, fontWeight: 'bold', color: '#0f1c3d'}}>
              Mahmudul Hasan
            </Text>
          </View>
          <View
        ...
        <View style={{paddingHorizontal: 15, paddingVertical: 5}}>
          ...
          <Text style={{fontSize: 28, fontFamily: 'sans-serif-light'}}>
            best place{' '}
            <Text style={{fontWeight: 'bold', color: '#4972df'}}>nearby</Text>{' '}
            👌
          </Text>
        </View>
        <View
        ...
        if (routeName === 'Home') {
          return (
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <Text
                style={{fontSize: 16, fontWeight: 'bold', color: tintColor}}>
                Home
              </Text>
              <View
                style={{
